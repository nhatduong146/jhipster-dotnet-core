...
using AuthenticationService = JhipsterExample.Domain.Services.AuthenticationService;
using IAuthenticationService = JhipsterExample.Domain.Services.Interfaces.IAuthenticationService;
